...
class FileWriter:
    def __init__(
        ...
        self._write_broken_url_file_path = os.path.join(self._data_dir, WRITE_BROKEN_URL_FILENAME)
        # create files
        self._create_url_file_with_headers_if_not_exists(self._write_url_filepath)
        self._create_broken_url_file_with_headers_if_not_exists(self._write_broken_url_file_path)
        # queues
    ...
    async def write_url_file(self):
        ...
        while True:
            ...
            with open(self._write_url_filepath, mode="a", newline="", encoding="utf-8") as _file:
                writer = csv.writer(_file)
                writer.writerow([write_url.url, write_url.depth, write_url.read_timestamp])
    ...
    async def write_broken_url_file(self):
        ...
        while True:
            ...
            with open(self._write_broken_url_file_path, mode="a", newline="", encoding="utf-8") as _file:
                writer = csv.writer(_file)
